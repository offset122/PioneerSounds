...
export default function Equipment() {
  const equipmentCategories = [
    {
      ...
      description: "Professional digital mixing boards for precise audio control",
    ...
    },
    {
      ...
      description: "Full range, mid range, and subwoofer systems for powerful sound",
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1571327073757-950377e25a82?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&h=600",
      items: [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1514525253161-7a46d19cd819?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&h=600",
      items: [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1598488035139-bdbb2231ce04?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&h=600",
      items: [
  ...
  const brands = [
    { name: "SHURE", description: "Professional microphones and audio equipment" },
  ...
  return (
    <div className="min-h-screen bg-pioneer-navy">
      ...
      <section className="pt-20 pb-16 bg-gradient-pioneer">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
            Industry-leading brands and cutting-edge technology for exceptional event experiences
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-pioneer-navy">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-white mb-4">Trusted Brands</h2>
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              We use only professional-grade equipment from industry-leading manufacturers
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {brands.map((brand, index) => (
              <div 
                ...
                style={{ animationDelay: `${index * 0.1}s` }}
              >
                <h3 className="text-2xl font-bold text-pioneer-orange mb-3">{brand.name}</h3>
      ...
      <section className="py-20 bg-pioneer-charcoal">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-400 mb-8 leading-relaxed">
            All our equipment is regularly maintained, tested, and calibrated to ensure optimal 
            performance at your event. Our technical team conducts pre-event checks and provides 
            on-site support to guarantee "clarity non-stop" throughout your event.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            <div className="bg-pioneer-navy p-6 rounded-xl">
              ...
              <p className="text-gray-400">All equipment undergoes scheduled maintenance and testing</p>
            </div>
            <div className="bg-pioneer-navy p-6 rounded-xl">
              <h3 className="text-xl font-bold text-white mb-3">Pre-Event Testing</h3>
              <p className="text-gray-400">Complete system testing before every event</p>
            </div>
            <div className="bg-pioneer-navy p-6 rounded-xl">
              <h3 className="text-xl font-bold text-white mb-3">On-Site Support</h3>
              <p className="text-gray-400">Technical team available throughout your event</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-pioneer-navy">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold text-white mb-6">Need Specific Equipment?</h2>
          <p className="text-xl text-gray-400 mb-8">
            Contact us to discuss your equipment requirements and get a customized quote
          </p>
          <button
