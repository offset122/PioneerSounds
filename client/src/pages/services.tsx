...
import { Volume2, Lightbulb, Tv, Guitar, Layers, Music, Zap, Headphones } from "lucide-react";
  ...
  const mainServices = [
    {
      ...
      description: "High-quality audio equipment for crystal-clear sound reproduction at any venue size.",
      features: [
    ...
    },
    {
      ...
      description: "Dynamic lighting solutions to create the perfect ambiance and visual impact for your event.",
      features: [
    ...
    },
    {
      ...
      description: "State-of-the-art visual display solutions for presentations, entertainment, and live broadcasts.",
      features: [
    ...
    },
    {
      ...
      description: "Complete musical instrument setup and amplification for live performances.",
      features: [
    ...
    },
    {
      ...
      description: "Professional staging systems for performances, presentations, and ceremonies.",
      features: [
    ...
    },
    {
      ...
      description: "Complete DJ setups with decks, controllers, and sound systems for parties and events.",
      features: [
  ...
  const additionalServices = [
    {
      ...
      description: "Reliable power generators to ensure uninterrupted event operation."
    },
    {
      icon: Headphones,
      title: "Professional Microphones",
      description: "SHURE SM58, PG30 headset, lavalier, and specialty microphones."
    }
  ];
  ...
  const eventTypes = [
    {
      ...
      venues: ["Safari Park", "Windsor Golf Club", "Great Rift Valley Lodge", "Marula Manor - Karen"]
    },
    {
      title: "Corporate Events",
      description: "Professional setups for business conferences and gatherings",
      venues: ["Sankara Hotel", "PanAfric Hotel", "Crowne Plaza", "National Museums"]
    },
    {
    ...
    {
      title: "Church Events",
      description: "Audio systems for worship services and religious gatherings",
  ...
  return (
    <div className="min-h-screen bg-pioneer-navy">
      ...
      <section className="pt-20 pb-16 bg-gradient-pioneer">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
            Professional equipment rental for all your event needs - delivering "clarity non-stop"
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-pioneer-charcoal">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-white mb-4">Event Types We Cover</h2>
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {eventTypes.map((eventType, index) => (
              <div 
                ...
                style={{ animationDelay: `${index * 0.1}s` }}
              >
                <h3 className="text-xl font-bold text-white mb-3">{eventType.title}</h3>
                <p className="text-gray-400 mb-4 text-sm">{eventType.description}</p>
                <div className="space-y-1">
                  <p className="text-pioneer-orange font-semibold text-sm mb-2">Featured Venues:</p>
                  {eventType.venues.map((venue, venueIndex) => (
                    <p key={venueIndex} className="text-gray-300 text-xs">• {venue}</p>
                  ))}
                </div>
              </div>
            ))}
