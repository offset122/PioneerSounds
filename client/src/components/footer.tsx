    ...
    <footer className="bg-pioneer-charcoal border-t border-gray-800 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-400 mb-4">"service beyond the obvious"</p>
          ...
          <div className="flex justify-center space-x-6 mb-8">
            ...
            <a 
              href="https://www.facebook.com/profile.php?id=100063770404102"
              className="text-gray-400 hover:text-pioneer-orange transition-colors duration-300"
          ...
          <div className="border-t border-gray-700 pt-8">
            <p className="text-gray-400">&copy; 2025 Pioneer Sounds. All Rights Reserved.</p>
          </div>
        </div>
      </div>
    </footer>
