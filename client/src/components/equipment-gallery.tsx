      ...
      items: [
        {
          ...
          description:
            "Professional-grade digital mixing boards for precise audio control and crystal-clear sound reproduction.",
          image:
        ...
        },
        {
          ...
          description:
            "Full range, mid range, and subwoofers delivering powerful, clear audio for any venue size.",
          image:
      ...
      items: [
        {
          ...
          description:
            "Complete range including SM58 corded/cordless, PG30 headset, lavalier, and drumset microphones.",
          image:
        ...
        },
        {
          ...
          description:
            "Professional DJ setups with turntables, controllers, and monitoring systems for seamless performances.",
          image:
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 animate-slide-up">
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Industry-leading brands and cutting-edge technology
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          {equipmentCategories.map((category, categoryIndex) => (
            <div key={categoryIndex} className="space-y-8">
              <h3 className="text-3xl font-bold text-pioneer-orange mb-6">
                {category.title}
              </h3>
              ...
              {category.items.map((item, itemIndex) => (
                <div
                  ...
                  style={{
                    animationDelay: `${(categoryIndex * 2 + itemIndex) * 0.2}s`,
                  }}
                >
                  <img
                    src={item.image}
